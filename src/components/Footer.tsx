    ...
    <footer className="bg-[#eaecff] text-black py-4 w-full">
      <div className="container mx-auto flex flex-col items-center space-y-2">
        <div className="flex space-x-4">
          <HoveredLink href="https://twitter.com" className="text-black hover:underline flex items-center">
            <span>Follow me</span>
          ...
          <HoveredLink href="/newsletter" className="text-black hover:underline flex items-center">
        ...
        <p className="text-xs text-gray-500">&copy; {new Date().getFullYear()} seashellscripts.com</p>
      </div>
    </footer>
  );
}
