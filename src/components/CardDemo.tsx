    ...
    <div className="max-w-xs w-full">
      ...
      >
        <div className="text relative z-50">
          ...
          <div className="text-neutral-200 mt-4 relative z-50">
            <p>Here's what sets me apart:</p>
            <ul className="list-none mt-2">
              <InfoItem title="Innovation" />
              <InfoItem title="Professionalism" />
              <InfoItem title="Reliability" />
              <InfoItem title="Passion" />
            </ul>
          </div>
