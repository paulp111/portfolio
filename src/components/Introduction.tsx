    ...
    <div className="flex justify-center items-center flex-col px-4">
      <div className="text-neutral-800 dark:text-neutral-200 text-xl md:text-3xl max-w-3xl mx-auto mb-6 text-left">
        <p className="mb-6">
          ...
          <span className="font-bold">Paul</span>, a code enthusiast dedicated
          to transforming ideas into reality through technology and creativity.
        </p>
        <p className="mb-6">
          This{" "}
        ...
        <p className="mb-6">
          Dive in, explore, and let's build something extraordinary{" "}
